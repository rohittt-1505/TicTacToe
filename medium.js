...
function aiMove(difficulty) {
    ...
    if (difficulty === 'medium') {
        ...
        aiMove = easyAIMove(emptyCells); // You can replace this with hard difficulty logic in the future
    }
...
function mediumAIMove(emptyCells) {
    // In medium difficulty, AI will try to block player moves and make strategic moves
    // For simplicity, AI randomly picks from available cells for medium difficulty
    return emptyCells[Math.floor(Math.random() * emptyCells.length)];
}

function easyAIMove(emptyCells) {
